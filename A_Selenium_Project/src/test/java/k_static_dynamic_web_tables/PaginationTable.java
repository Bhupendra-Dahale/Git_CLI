package k_static_dynamic_web_tables;
...
public class PaginationTable {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement login = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//button[text()=' Login']"))));
		login.click();
		...
		for(int p=1;p<=total_pages;p++)
		{
			...
			for(int r=1;r<=noOfrows;r++)
			{
				...
				System.out.println("CustomerName : "+customerName+" CustomerEmail : "+customerEmail+" Status : "+status);
			}
