...
public class CSSSelectorsDemo {
	...
	public static void main(String[] args) {
		...
		//starts with - ^
		driver.findElement(By.cssSelector("input[class^='search-box']")).sendKeys("Cars");
		//contains - *
		driver.findElement(By.cssSelector("input[class*='box']")).sendKeys("Bikes");
		//ends with - $
		driver.findElement(By.cssSelector("input[class$='autocomplete-input']")).sendKeys("Aeroplane");
	}
